...
export async function healthRoutes(fastify: FastifyInstance) {
  ...
  fastify.get('/health/ready', {
    ...
    try {
      const clinicalProcessor = (fastify as any).clinicalProcessor;
      ...
      const structuredExtractor = (fastify as any).structuredExtractor;
      const databaseService = (fastify as any).databaseService;
      const monitoringService = (fastify as any).monitoringService;

      const servicesReady = clinicalProcessor?.isInitialized && 
